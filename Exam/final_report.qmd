...
The repository is available at https://github.com/a-asen/PSY-3006-Visualization (as part of the course requirement). The code related to the exam will be published as a "release" using the tag "exam". The exam pertain to approximately 11100 words, which corresponds to about 25 pages of text.
