...
For the second exercise, I tried to visualize sleep time between two conditions. In one of the conditions participants were sleep deprived, while in the other they slept normally. For the sleep deprivation condition, participants were asked to go to sleep 3 hours later than when they typically go to bed (i.e., under normal sleep). 
