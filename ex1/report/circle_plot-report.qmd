...
Reducing the daylight length by half leads to an extended range of the daylight length. This seems to be a better compromise between data points and displaying daylight hours.  This time, the daylight length is reduce by half, extending beyond the sleep amount. 
