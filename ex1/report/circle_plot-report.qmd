...
Reducing the daylight length by half leads to an extended range of the daylight length. This seems to be a better compromise between data points and displaying daylight hours. Although it is more difficult to see the difference between each data point.  
