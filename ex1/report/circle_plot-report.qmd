...
Although we are more able to see difference in the data point, the cluster in the center of the plot is not that neat. One of the ideas of visualizing sleep with sleep time and wake time, is that we can create a range, which indicate the amount of sleep. 
