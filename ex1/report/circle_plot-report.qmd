...
One way to ameliorate this problem is to reduce the amount of data that is plotted. This can be done by summarizing to weeks or months.  In this way, the circular plotting 
...
sleep_data2 |> 
  ...
  geom_point(alpha=.5)+
  stat_summary(fun.data=mean_cl_normal, geom="pointrange",
               position=position_nudge(.075), color="red")+
