...
To sum it all together, I will create a final circle plot and a standard plot with the same information and discuss which I would rather use. 
...
```{r circle sleep amount 13 - normal}
reduction <- 4.8
additional_start <- 5
sleep_data |>
  ggplot(aes(x=cumulative_days, y=sleep_amount))+
