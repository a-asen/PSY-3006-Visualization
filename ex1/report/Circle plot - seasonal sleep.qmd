...
Compare to a normal plot: [Code hidden as only "geom_polar" is removed]
...
In relatioAs for the two points relating to changing the scale and adding sleep time and wake time.
