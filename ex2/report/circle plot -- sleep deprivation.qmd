...
sleep_and_data |> 
  ...
  summarize(
    ...
    NS_s_duration = mean(sleep_duration[sleepdep=="control"], na.rm=T),
    PSD_s_duration = mean(sleep_duration[sleepdep=="SD"], na.rm=T),
  ...
  pivot_longer(1:7, names_pattern = "(.s_duration)(.sleep_time)(wake_time)",
               names_to=c("one", "two", "tree"), ) 
