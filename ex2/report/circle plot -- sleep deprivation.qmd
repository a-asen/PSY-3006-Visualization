...
sleep |>
  ...
  ggplot(aes(x=sleep, y=duration, fill=sleepdep, col=sleepdep))+
  geom_point(size=2.5)+
  geom_errorbar()# WORK FROM HERE

```

Here I improved upon the data transformation and included a calculation of the standard error. This .. (will be used to estimate the error of the mean)
